...
class TicketItemsControllerTest < ActionController::TestCase
  ...
  test "should create ticket_item" do
    assert_difference('TicketItem.count') do
      post :create, ticket_item: { description: @ticket_item.description, title: @ticket_item.title, user_id: @ticket_item.user_id }
    end
  ...
  test "should update ticket_item" do
    patch :update, id: @ticket_item, ticket_item: { description: @ticket_item.description, title: @ticket_item.title, user_id: @ticket_item.user_id }
    assert_redirected_to ticket_item_path(assigns(:ticket_item))
  end
