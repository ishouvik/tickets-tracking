class Admin::TicketCategoriesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @ticket_category.save
        format.html { redirect_to [:admin, @ticket_category], notice: 'Ticket category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @ticket_category.update(ticket_category_params)
        format.html { redirect_to [:admin, @ticket_category], notice: 'Ticket category was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_ticket_categories_url, notice: 'Ticket category was successfully destroyed.' }
